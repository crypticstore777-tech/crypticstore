  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col justify-center items-center text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 text-foreground drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">Crypt?c Store?​
          <span className="text-primary drop-shadow-[0_0_30px_hsla(50,100%,50%,0.6)]">2</span>​
          </h1>
